...
**
** Created: Wed Dec 8 00:44:20 2010
...
static const char qt_meta_stringdata_MotionForm[] = {
    ...
    "saveFile()\0resetParams()\0convertToAnm()\0"
};

const QMetaObject MotionForm::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MotionForm,
...
void *MotionForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AbstractWindow"))
        return static_cast< AbstractWindow*>(const_cast< MotionForm*>(this));
...
int MotionForm::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: resetParams(); break;
        case 4: convertToAnm(); break;
        default: ;
        }
        _id -= 5;
    }
